...
exclude_patterns = [
    ...
    "accelerators/gpu.rst",
    "accelerators/hpu.rst",
    "accelerators/ipu.rst",
    "accelerators/mps.rst",
    "accelerators/tpu.rst",
    ...
    "clouds/cloud_training.rst",
    "clouds/cluster.rst",
    "clouds/cluster_advanced.rst",
    "clouds/cluster_intermediate_2.rst",
    "clouds/fault_tolerant_training.rst",
    ...
    "common/trainer.rst",
    "debug/debugging.rst",
    "deploy/production.rst",
    "deploy/production_advanced.rst",
    "deploy/production_basic.rst",
    "deploy/production_intermediate.rst",
    "extensions/accelerator.rst",
    "extensions/callbacks.rst",
    "extensions/datamodules_state.rst",
    "extensions/loops.rst",
    "extensions/plugins.rst",
    "governance.rst",
    "levels/advanced.rst",
    "levels/core_skills.rst",
    "levels/expert.rst",
    "levels/intermediate.rst",
    "starter/converting.rst",
    "starter/style_guide.rst",
    "strategies/hivemind.rst",
    "tuning/profiler.rst",
    "visualize/experiment_managers.rst",
    "visualize/loggers.rst",
    "visualize/logging_intermediate.rst",
]
